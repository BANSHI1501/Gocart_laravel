            ...
            >
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-2">
                        {categories.map((item) => {
                            const isSelected = category === item.path;
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 rounded-2xl border px-3 py-4 text-center transition-all ${
                                        isSelected
                                            ? "border-primary bg-primary/5 shadow-[0_8px_24px_rgba(138,75,255,0.12)]"
                                            : "border-gray-500/20 bg-white/70 hover:border-primary/40 hover:bg-primary/5"
                                    }`}
                                >
                                    <img
                                        src={item.image}
